...
- **Enter project name:** `Student_App_Page`  
- Under **Pipeline Definition**, select **Pipeline script from SCM**  
- **SCM:** Git  
- **Repository URL:** `https://github.com/Adiii-AJ/Student_App_Page.git`  
- **Branch:** `main`  
...
|------|--------------|-------------|
| 1️⃣ | EC2 instance dashboard| ![Jenkins Build Success](Images/EC2.png) |
| 2️⃣ | GitHub repository | ![Maven Build Stage](Images/GitHub_Repo.png) |
| 3️⃣ | Jenkins console output | ![Tomcat Deployment Complete](Images/Jenkins_Console_Output.png) |
| 4️⃣ | VS Code View | ![Final Java App Running](Images/VsCode_View.png) |
| 5️⃣ | Finial Output | ![Final Java App ](Images/Final_Output.png) |
...
👨‍💻 **Aditya Jangam**  
💼 AWS | DevOps  
🔗 [LinkedIn](http://www.linkedin.com/in/adityajangam777)  
📧 **adityajangam777@gmail.com**
